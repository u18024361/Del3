...
@Component({
  selector: 'app-individualsession',
  templateUrl: './individualsession.component.html',
  styleUrls: ['./individualsession.component.scss'],
  providers: [{
...
export class IndividualsessionComponent implements OnInit {
   el:any = document.createElement("a");
  ...
  ngOnInit(): void {
    this.appService.getEvents(this.actions)
            ...
            this.el.innerHTML = "Link: <a href='http://Zoom/jj/1123'>link</a>";
           this.el.href = "www.stackoverflow.com";
        this.el.innerText = "Click here";
